...
class reverbnation_master_admin_addons_table extends WP_List_Table {
	...
	$path = WP_CONTENT_DIR . '/plugins/reverbnation-master-addons/';
	if ( is_plugin_active( 'reverbnation-master-addons/reverbnation-master-addons.php' ) && file_exists($path) ) {
		...
		$reverbnation_master_addon_get = '<a class="button-primary" href="https://wordpress.techgasp.com/reverbnation-master/" target="_blank" title="Get all Add-ons" style="float:left;">Get all Add-ons pack for peanuts</a>';
	}
?>
<table class="widefat" cellspacing="0">
	<thead>
		<tr>
			<th colspan="3"><?php echo $reverbnation_master_addon_get; ?></th>
		</tr>
		<tr>
	...
	<tbody>
		<tr class="alternate">
			...
			<td style="vertical-align:middle"><h3>Reverbnation Buttons Widget</h3><p>Reverbnation Master Buttons Widget is perfect to connect your wordpress visitors and users to your Reverbnation Profile. Watch those profile visits explode!.</p><p>Looks great when published under the advanced widget, remember you can always hide the widget title to get the button closer to your video.</p><p>Navigate to your wordpress widgets page and start using it. <a href="https://wordpress.techgasp.com/reverbnation-master/" target="_blank"><strong>Demo Link</strong></a>.</p></td>
		...
		<tr class="alternate">
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-admin-addons-widgets.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Reverbnation User Profile Widget</h3><p>An Advanced Reverbnation User Profile Widget packed with options and perfect to display user content. This widget includes the famous <b>TechGasp Bang! Artwork Display</b>, for users with great Cover Artworks and is <b>Fully Mobile Responsive</b>.</p><p>Navigate to your wordpress widgets page and start using it. <a href="https://wordpress.techgasp.com/reverbnation-master/" target="_blank"><strong>Demo Link</strong></a>.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$reverbnation_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-admin-addons-widgets.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="300px" height="139px" style="padding:5px;"/></td>
			<td style="vertical-align:middle"><h3>Reverbnation Administrator Dashboard Widget</h3><p>The wordpress administrator dashboard widget allows you to have any native reverbnation widget inside your wordpress dashboard page.</p><p>Very useful to listen to music or have your reverbnation schedule close by while you work on your wordpress.</p><p>Navigate to your wordpress widgets page and start using it. <a href="https://wordpress.techgasp.com/reverbnation-master/" target="_blank"><strong>Demo Link</strong></a>.</p></td>
			<td style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-check-'.$reverbnation_master_addon.'.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
